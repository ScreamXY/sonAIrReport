    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="space-y-2">
          <div className="w-12 h-12 mx-auto bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center">
            {dragActive ? (
          ...
          <div>
            <p className="font-medium text-slate-700">
              {dragActive ? 'Drop screenshots here' : screenshots.length > 0 ? 'Add more screenshots' : 'Add SonarCloud Screenshots'}
            </p>
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`
            ...
            border border-slate-200 rounded-xl text-slate-600 text-sm
        ...
        <button
          ...
          className={`
            flex-1 flex items-center justify-center gap-2 px-4 py-2.5
            bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl text-sm font-medium
            hover:opacity-90 transition-opacity shadow-md
            ${(isAnalyzing || screenshots.length === 0) ? 'opacity-50 cursor-not-allowed' : ''}
          `}
        >
